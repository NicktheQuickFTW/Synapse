...
const knex = require('./tennis-app/src/db/knex');
// Import tiebreaker functions
const { applyTiebreakers, getHeadToHead } = require('./tennis-app/src/tiebreakers/tennis/tennis_tiebreaker');
...
const matches = [
  { id: 1, team1: 'Texas Tech', team2: 'Oklahoma State', score: '4-3', date: '2025-03-20' },
...
app.get('/matches', async (req, res) => {
  ...
  try {
    ...
    const requestBody = {
      script: 'scripts/get_tennis_data.py',
