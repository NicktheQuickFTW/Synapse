...
async function queryMensTennisData() {
    try {
        console.log('\n=== Big 12 Men\'s Tennis Data (EXCLUSIVELY) ===\n');
        ...
        if (teams.length === 0) {
            console.log('No data found for men\'s tennis');
            return;
        }
        ...
        console.log('Current Men\'s Tennis Standings:');
        console.log('---------------------------\n');
        ...
        console.log('\nMen\'s Team Schedules (Conference Games):');
        console.log('---------------------------------------\n');
        ...
        console.log('\nNOTE: This script exclusively shows men\'s tennis data. For women\'s tennis, use the dedicated script for women\'s tennis.');
        console.log('While men\'s and women\'s tennis share the same tiebreaker rules, their data and statistics are kept completely separate.');
